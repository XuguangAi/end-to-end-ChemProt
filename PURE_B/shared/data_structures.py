...
def evaluate_predictions(dataset):
    ...
    scores_ner = compute_f1(
        counts["ner_predicted"], 20828, counts["ner_matched"])
    scores_relations = compute_f1(
        counts["relations_predicted"], 3458, counts["relations_matched"])
    scores_strict_relations = compute_f1(
        counts["relations_predicted"], 3458, counts["strict_relations_matched"])
